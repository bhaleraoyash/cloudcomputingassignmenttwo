...
def lambda_handler(event, context):
    ...
    url = "https://search-photos-uyhb4sgvhvdnc7kklvhnoppgsm.us-east-1.es.amazonaws.com/photos/_doc/"
    headers = {"Content-Type": "application/json"}
    r = requests.post(url,auth=('yb2145', 'Test1234#'),data=json.dumps(format).encode("utf-8"), headers=headers)
    return {
        'statusCode': 200,
